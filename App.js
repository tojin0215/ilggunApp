...
const App = () => {
	...
	function callback() {
		try {
			axios
				.post(
					'http://13.124.141.28:3000/selectReceivedNewMessage',
					{
						t: realId,
					},
					{
				...
				>
					{isAuthenticated ? (
						<>
							...
							/>
							<RootStack.Screen
								name='Worker Business List'
								component={WorkerBusinessListScreen}
								options={({ route, navigation }) => ({
									title: '',
									headerTitle: getFocusedRouteNameFromRoute(route),
									headerStyle: {
									...
									headerRight: () => (
										<View style={styles.rowArea}>
											...
											<TouchableOpacity
												onPress={handleSignOut}
												style={styles.workerlogoutBtnArea}
											>
												<Image
													style={styles.logoutImage}
													source={require('./img/logout.png')}
							...
							<RootStack.Screen name='Map2' component={MapScreen2} />
							<RootStack.Screen
								name='Home'
                    ...
                    />*/
							...
							<RootStack.Screen
								...
								name='Modify Password1'
								component={ModifyPasswordScreen1}
							/>
							<RootStack.Screen
								options={{
									title: '비밀번호 수정',
								}}
								name='Modify Password2'
								component={ModifyPasswordScreen2}
							/>
							<RootStack.Screen
								options={{
									title: '서명 수정',
							...
							<RootStack.Screen
								...
								component={ModifyBusinessScreen}
							/>
							<RootStack.Screen
								options={{
									title: '달력',
							...
							<RootStack.Screen
								...
								name='Contract Form'
								component={ContractformScreen} //WorkerManageScreen}
							/>
							<RootStack.Screen
								options={{
									title: '계약서',
								...
								name='Contract FormA'
								component={ContractformAScreen} //WorkerManageScreen}
							/>
							<RootStack.Screen
								options={{
									title: '계약서',
								...
								name='Contract FormB'
								component={ContractformBScreen} //WorkerManageScreen}
							/>
							<RootStack.Screen
								options={{
									title: '근로자 관리',
								...
								component={WorkerTabs} //WorkerManageScreen}
							/>
							<RootStack.Screen
								options={{
									title: '계산하기',
						...
						<>
							<RootStack.Screen name='Sign In' options={{ headerShown: false }}>
