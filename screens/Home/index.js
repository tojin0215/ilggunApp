			...
			<View style={styles.container}>
				<View style={styles.buttonArea1}>
					...
					>
						<Image
							...
							source={
								clicked == 0
									? require('../../img/workManagement_clicked.png')
									: require('../../img/workManagement.png')
							}
						/>
					</TouchableOpacity>
					...
					>
						<Image
							...
							source={
								clicked2 == 0
									? require('../../img/workerManagement_clicked.png')
									: require('../../img/workerManagement.png')
							}
						/>
					</TouchableOpacity>
				</View>
				...
				<View style={styles.buttonArea2}>
					...
					>
						<Image
							...
							source={
								clicked3 == 0
									? require('../../img/calculating_clicked.png')
									: require('../../img/calculating.png')
							}
						/>
					</TouchableOpacity>
					<TouchableOpacity
					...
					>
						<Image
							...
							source={
								clicked4 == 0
									? require('../../img/statement_clicked.png')
									: require('../../img/statement.png')
							}
						/>
					</TouchableOpacity>
				</View>
				...
				>
					<Image
						...
						source={require('../../img/addBtn1.png')}
					/>
				</TouchableOpacity>
				...
				>
					<Image
						style={styles.addbuttonImg}
						source={require('../../img/addBtn2.png')}
					/>
				</TouchableOpacity>
				...
				<View style={styles.buttonArea3}>
					...
					>
						<Text style={styles.settingButtonTitle}>사업장 정보 수정</Text>
					</TouchableOpacity>
				</View>
			</View>
		</View>
