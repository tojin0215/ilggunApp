...
class ContractformScreen extends Component{
  ...
  /*fetchPdf = async(uri) => {
    ...
    StatementScreen = async() => {
      axios.post('https://www.toojin.cf:3000/selectImg', {},
      {  headers:{
        'Content-Type':'application/json',
      'Accept': 'application/json'}
    })
      /*fetch("https://www.toojin.cf:3000/selectImg",{
        method: 'POST',})*/
          .then(res => 
            {
              console.log(res)
    ...
    this.state = {
      ...
      <body>
          ...
          <div>
            ...
            <img style="left: 270px; height:10px; width: 10px; bottom: 180px; font-size: 1.8em; font-weight: bold; position: absolute;" src="https://www.toojin.cf:3000/11.jpg">
