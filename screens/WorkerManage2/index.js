...
import { View, Text, StyleSheet, Button,ImageBackground,TouchableOpacity, Image,ScrollView, Alert,Platform } from 'react-native';
            ...
            <View style={styles.worker} key={id}>
              ...
              <Text style={styles.textTitle}>{b.workername2}</Text><Text style={styles.textTitle2}>({b.workername.substr(0,4)}{b.workername.length>4?'**':''})</Text>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if(b.state!=0){
                      navigation.navigate(('Contract FormB'),{workername: b.workername,workername2:b.workername2, bid:idid })
                    }
                  }}>
                  {b.state==0?
